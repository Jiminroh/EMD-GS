...
*/
    ...
    function Ea(a, b) {
        wa(a.i); var c = a.i.m; if (c) return Fa(a, "return" in c ? c["return"] : function (d) { return { value: d, done: !0 } }, b, a.i.return);
    ...
    function Ha(a) {
        this.next = function (b) { wa(a.i); a.i.m ? b = Fa(a, a.i.m.next, b, a.i.N) : (a.i.N(b), b = Ga(a)); return b };
    ...
    n("Promise", function (a) {
        function b(g) { this.i = 0; this.l = void 0; this.j = []; this.B = !1; var h = this.m(); try { g(h.resolve, h.reject) } catch (k) { h.reject(k) } }
        ...
        b.prototype.then = function (g, h) {
            function k(x, u) { return "function" == typeof x ? function (A) { try { m(x(A)) } catch (E) { q(E) } } : u }
            var m, q, r = new b(function (x, u) { m = x; q = u });
            this.Sa(k(g, m), k(h, q)); return r
        };
        b.prototype.catch = function (g) { return this.then(void 0, g) };
        b.prototype.Sa = function (g, h) {
            function k() { switch (m.i) { case 1: g(m.l); break; case 2: h(m.l); break; default: throw Error("Unexpected state: " + m.i); } }
        ...
        b.all = function (g) {
            var h = p(g), k = h.next(); return k.done ? d([]) : new b(function (m, q) {
                function r(A) { return function (E) { x[A] = E; u--; 0 == u && m(x) } }
    ...
    n("WeakMap", function (a) {
        function b(k) { this.i = (h += Math.random() + 1).toString(); if (k) { k = p(k); for (var m; !(m = k.next()).done;)m = m.value, this.set(m[0], m[1]) } }
        function c() { }
    ...
    var Qc; a: {
        var Rc = "", Sc = function () { var a = Tb(); if (Mc) return /rv:([^\);]+)(\)|;)/.exec(a); if (Lc) return /Edge\/([\d\.]+)/.exec(a); if (Kc) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (Nc) return /WebKit\/(\S+)/.exec(a); if (Jc) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        Sc && (Rc = Sc ? Sc[1] : ""); if (Kc) { var Tc = Pc(); if (null != Tc && Tc > parseFloat(Rc)) { Qc = String(Tc); break a } } Qc = Rc
    } var Uc = Qc, Ic = {};
    ...
    re.prototype.preventDefault = function () { this.defaultPrevented = !0 }; function se(a) {
        var b = B("window.location.href"); null == a && (a = 'Unknown Error of type "null/undefined"'); if ("string" === typeof a) return { message: a, name: "Unknown error", lineNumber: "Not available", fileName: b, stack: "Not available" }; var c = !1; try { var d = a.lineNumber || a.line || "Not available" } catch (g) { d = "Not available", c = !0 } try { var e = a.fileName || a.filename || a.sourceURL || y.$googDebugFname || b } catch (g) { e = "Not available", c = !0 } b = te(a); if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            c = a.message; if (null ==
    ...
    }(); function xe(a, b) { re.call(this, a ? a.type : ""); this.relatedTarget = this.i = this.target = null; this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0; this.key = ""; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1; this.state = null; this.pointerId = 0; this.pointerType = ""; this.j = null; a && this.init(a, b) }
    Za(xe, re); var ye = { 2: "touch", 3: "pen", 4: "mouse" };
    xe.prototype.init = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches && a.changedTouches.length ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.i = b; if (b = a.relatedTarget) { if (Mc) { a: { try { Gc(b.nodeName); var e = !0; break a } catch (f) { } e = !1 } e || (b = null) } } else "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement); this.relatedTarget = b; d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY ||
    ...
    var Ye = "__closure_events_fn_" + (1E9 * Math.random() >>> 0); function Qe(a) {
        if ("function" === typeof a) return a; a[Ye] || (a[Ye] = function (b) { return a.handleEvent(b) });
        return a[Ye]
    }
    ...
    ; var kf; function lf() {
        var a = y.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C("Presto") && (a = function () {
            var e = hf("IFRAME"); e.style.display = "none"; document.documentElement.appendChild(e); var f = e.contentWindow; e = f.document; e.open(); e.close(); var g = "callImmediate" + Math.random(), h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host; e = Wa(function (k) { if (("*" == h || k.origin == h) && k.data == g) this.port1.onmessage() }, this);
            f.addEventListener("message", e, !1); this.port1 = {}; this.port2 = { postMessage: function () { f.postMessage(g, h) } }
        });
        if ("undefined" !== typeof a && !Ub()) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.Kb; c.Kb = null; e() } };
            return function (e) { d.next = { Kb: e }; d = d.next; b.port2.postMessage(0) }
    ...
    function uf() {
        if (y.Promise && y.Promise.resolve) { var a = y.Promise.resolve(void 0); qf = function () { a.then(vf) } } else qf = function () {
            var b = vf;
    ...
    function Cf(a, b, c, d) {
        var e = Af(null, null, null); e.i = new wf(function (f, g) {
    ...
    l.gb = function () {
        var a = this.i.values(); a = [].concat(ia(a)).filter(function (b) { return b.xa.size });
    ...
    function jg(a, b, c) {
        var d = [], e = []; if (1 == (Array.isArray(c) ? 2 : 1)) return e = [b, a], fb(d, function (h) { e.push(h) }), kg(e.join(" "));
    ...
    function xg(a, b, c) {
        if (null == b) c.push("null"); else {
            if ("object" == typeof b) { if (Array.isArray(b)) { var d = b; b = d.length; c.push("["); for (var e = "", f = 0; f < b; f++)c.push(e), xg(a, d[f], c), e = ","; c.push("]"); return } if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf(); else { c.push("{"); e = ""; for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), zg(d, c), c.push(":"), xg(a, f, c), e = ",")); c.push("}"); return } } switch (typeof b) {
                case "string": zg(b, c); break; case "number": c.push(isFinite(b) &&
    ...
    l.send = function (a, b, c, d) {
        ...
        e = y.FormData && a instanceof y.FormData; !(0 <= eb(Jg, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); b = p(c); for (d = b.next(); !d.done; d = b.next())c = p(d.value), d = c.next().value, c = c.next().value, this.C.setRequestHeader(d, c); this.da && (this.C.responseType = this.da); "withCredentials" in this.C && this.C.withCredentials !== this.X && (this.C.withCredentials = this.X); try {
            Ng(this), 0 < this.s && (this.W = Og(this.C), this.getStatus(), this.W ? (this.C.timeout = this.s, this.C.ontimeout = Wa(this.mc, this)) :
                this.G = Pf(this.mc, this.s, this)), this.getStatus(), this.A = !0, this.C.send(a), this.A = !1
        } catch (g) { this.getStatus(), Mg(this, g) }
    };
    ...
    function Sg(a, b) {
        if (a.C) {
            Ng(a); var c = a.C, d = a.J[0] ? function () { } : null;
    ...
    t(gh, I); var hh; hh = new function (a, b, c) { this.j = a; this.fieldName = b; this.i = c; this.isRepeated = 0; this.l = he }(175237375, { Jq: 0 }, gh); function ih(a, b, c, d, e, f, g, h, k, m, q) {
        Ze.call(this); var r = this; this.P = ""; this.l = []; this.Gb = ""; this.Hb = this.ra = -1; this.Oa = !1; this.J = this.o = null; this.G = 0; this.uc = 1; this.timeoutMillis = 0; this.da = !1; Ze.call(this); this.Fb = b || function () { };
    ...
    ih.prototype.flush = function (a, b) {
        var c = this; if (0 === this.l.length) a && a(); else if (this.da) ph(this); else {
            var d = Date.now(); if (this.Hb > d && this.ra < d) b && b("throttled"); else {
                var e = qh(this.A, this.l, this.G); d = {}; var f = this.Fb(); f && (d.Authorization = f); var g = mh(this); this.K && (d["X-Goog-AuthUser"] = this.K, g = wc(g, "authuser", this.K)); this.pageId && (d["X-Goog-PageId"] = this.pageId, g = wc(g, "pageId", this.pageId)); if (f && this.Gb === f) b && b("stale-auth-token"); else {
                    this.l = []; this.j.enabled && this.j.stop(); this.G = 0; var h = be(e),
                        k; this.J && this.J.isSupported(h.length) && (k = this.J.compress(h)); var m = { url: g, body: h, zc: 1, xb: d, requestType: "POST", withCredentials: this.withCredentials, timeoutMillis: this.timeoutMillis }, q = function (u) { c.s.reset(); Of(c.j, c.s.getValue()); if (u) { var A = null; try { var E = JSON.parse(u.replace(")]}'\n", "")); A = new eh(E) } catch (F) { } A && (u = Number(Qd(A, 1, "-1")), 0 < u && (c.ra = Date.now(), c.Hb = c.ra + u), A = hh.l(A)) && (A = Qd(A, 1, -1), -1 != A && (c.Oa || nh(c, A))) } a && a() }, r = function (u, A) {
                            var E = Wd(e, ah, 3), F = c.s;
                            F.i = Math.min(3E5, 2 * F.i); F.j = Math.min(3E5, F.i + Math.round(.2 * (Math.random() - .5) * F.i)); Of(c.j, c.s.getValue()); 401 === u && f && (c.Gb = f); void 0 === A && (A = 500 <= u && 600 > u || 401 === u || 0 === u); A && (c.l = E.concat(c.l), c.W || c.j.enabled || c.j.start()); b && b("net-send-failed", u)
                        }, x = function () { c.Na ? c.Na.send(m, q, r) : c.sc(m, q, r) };
    ...
    wh.prototype.flush = function (a) {
        var b = a || []; if (b.length) {
            a = new eg; for (var c = [], d = 0; d < b.length; d++) {
                var e = b[d], f = e; var g = new Xf; g = D(g, 1, f.j); for (var h = f, k = [], m = 0; m < h.i.length; m++)k.push(h.i[m].jb); g = Rd(g, 3, k); h = []; k = []; m = p(f.xa.keys()); for (var q = m.next(); !q.done; q = m.next())k.push(q.value.split(",")); for (m = 0; m < k.length; m++) {
                    q = k[m]; var r = f.m; for (var x = f.lb(q) || [], u = [], A = 0; A < x.length; A++) { var E = x[A]; E = E && E.Lb; var F = new bg; switch (r) { case 3: Sd(F, 1, dg, Number(E)); break; case 2: Sd(F, 2, dg, Number(E)) }u.push(F) } r =
                        u; for (x = 0; x < r.length; x++) { u = r[x]; A = new Zf; u = G(A, bg, 2, u); A = q; E = []; F = f; for (var O = [], N = 0; N < F.i.length; N++)O.push(F.i[N].kb); F = O; for (O = 0; O < F.length; O++) { N = F[O]; var R = A[O], ca = new ag; switch (N) { case 3: Sd(ca, 1, cg, String(R)); break; case 2: Sd(ca, 2, cg, Number(R)); break; case 1: Sd(ca, 3, cg, "true" == R) }E.push(ca) } Yd(u, ag, 1, E); h.push(u) }
                } Yd(g, Zf, 4, h); c.push(g); e.clear()
            } Yd(a, Xf, 1, c); b = this.i; a instanceof ah ? b.log(a) : (c = new ah, a = be(a), a = D(c, 8, a), b.log(a)); this.i.flush()
        }
    ...
    ; function Ah(a) {
        var b = this; this.Ua = !1; if (a.Qq) { var c; this.sa = null != (c = a.sa) ? c : new xh } c = a.program; a = a.globalName; var d = new zh; this.j = d.promise; this.nd = p((0, y[a].a)(c, function (e, f) { Promise.resolve().then(function () { var g; if (null != (g = b.sa)) { var h = yh() - g.o; g.m.i.fb("/client_streamz/bg/fil", h, g.Aa) } d.resolve({ yc: e, kd: f }) }) }, !0)).next().value;
        this.jd = d.promise.then(function () { })
    }
    Ah.prototype.snapshot = function (a) {
        var b = this; if (this.Ua) throw Error("Already disposed"); var c = yh(), d; null != (d = this.sa) && d.j.i.Cb("/client_streamz/bg/fsc", d.Aa); return this.j.then(function (e) {
            var f = e.yc; return new Promise(function (g) {
                f(function (h) { var k; if (null != (k = b.sa)) { var m = yh() - c; k.l.i.fb("/client_streamz/bg/fsl", m, k.Aa) } g(h) }, [a.Nb,
                a.ld])
            })
        })
    };
...
*/
    ...
    function Jh() {
        var a = Kh(), b = {}; fb(Ih(), function (c) { a.sandbox && a.sandbox.supports && a.sandbox.supports(c) && (b[c] = !0) });
        return b
    }
    ...
    ; var Ph = (new Date).getTime(); var Qh = "client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" "); ia(Qh); function Rh(a) {
        Ze.call(this); var b = this; this.A = this.l = 0; this.Z = null != a ? a : {
            S: function (e, f) { return setTimeout(e, f) },
    ...
    function Sh(a, b) {
        return a.s ? a.s : a.s = new Promise(function (c) {
            var d, e, f, g; return w(function (h) {
                switch (h.i) {
                    case 1: return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, ya(h, 2, 3), d && (a.l = a.Z.S(function () { d.abort() }, b || 2E4)), v(h, fetch("/generate_204", {
                        method: "HEAD",
                        signal: f
                    }), 5); case 5: g = !0; case 3: Ba(h); a.s = void 0; a.l && (a.Z.fa(a.l), a.l = 0); g !== a.j && (a.j = g, a.j ? $e(a, "networkstatus-online") : $e(a, "networkstatus-offline")); c(g); Ca(h); break; case 2: Aa(h), g = !1, h.u(3)
                }
            })
        })
    }
    ...
    function Zh(a) {
        -1 === a.i && (a.i = ib(a.data_, function (b, c, d) { return c ? b + Math.pow(2, d) : b }, 0));
        return a.i
    }
    ...
    l.ea = function (a) {
        qi(this); var b = 0, c = this.oa, d = this, e = new ii; e.next = function () { if (c != d.oa) throw Error("The map has changed since the iterator was created"); if (b >= d.i.length) return ji; var f = d.i[b++]; return ki(a ? f : d.j[f]) };
        return e
    };
    ...
    l.ea = function (a) {
        var b = 0, c = this.i, d = new ii; d.next = function () { if (b >= c.length) return ji; var e = c.key(b++); if (a) return ki(e); e = c.getItem(e); if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ki(e) };
        return d
    };
    ...
    l.ea = function (a) {
        var b = 0, c = this.i.XMLDocument.documentElement.attributes, d = new ii; d.next = function () { if (b >= c.length) return ji; var e = c[b++]; if (a) return ki(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1)); e = e.nodeValue; if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ki(e) };
        return d
    };
    ...
    Ji.prototype.ea = function (a) {
        var b = this.j[Symbol.iterator](), c = this, d = new ii; d.next = function () { var e = b.next(); if (e.done) return e; for (e = e.value; e.slice(0, c.i.length) != c.i;) { e = b.next(); if (e.done) return e; e = e.value } return ki(a ? e.slice(c.i.length) : c.j.get(e)) };
        return d
    ...
    var Uk = String(Sk); function Vk(a) {
        var b = []; nb(a, function (c, d) { var e = encodeURIComponent(String(d)), f; Array.isArray(c) ? f = c : f = [c]; fb(f, function (g) { "" == g ? b.push(e) : b.push(e + "=" + encodeURIComponent(String(g))) }) });
        return b.join("&")
    }
    ...
    ; function $k(a) {
        var b = al; a = void 0 === a ? B("yt.ads.biscotti.lastId_") || "" : a; var c = Object, d = c.assign, e = {}; e.dt = Ph; e.flash = "0"; a: { try { var f = b.i.top.location.href } catch (ea) { f = 2; break a } f = f ? f === b.j.location.href ? 0 : 1 : 2 } e = (e.frm = f, e); try {
            e.u_tz = -(new Date).getTimezoneOffset(); var g = void 0 === g ? Bh : g; try { var h = g.history.length } catch (ea) { h = 0 } e.u_his = h; var k; e.u_h = null == (k = Bh.screen) ? void 0 : k.height; var m; e.u_w = null == (m = Bh.screen) ? void 0 : m.width; var q; e.u_ah = null == (q = Bh.screen) ? void 0 : q.availHeight; var r; e.u_aw =
                null == (r = Bh.screen) ? void 0 : r.availWidth; var x; e.u_cd = null == (x = Bh.screen) ? void 0 : x.colorDepth
        } catch (ea) { } h = b.i; try { var u = h.screenX; var A = h.screenY } catch (ea) { } try { var E = h.outerWidth; var F = h.outerHeight } catch (ea) { } try { var O = h.innerWidth; var N = h.innerHeight } catch (ea) { } try { var R = h.screenLeft; var ca = h.screenTop } catch (ea) { } try { O = h.innerWidth, N = h.innerHeight } catch (ea) { } try { var W = h.screen.availWidth; var ob = h.screen.availTop } catch (ea) { } u = [R, ca, u, A, W, ob, E, F, O, N]; try {
            var Ya = (b.i.top || window).document, la = "CSS1Compat" ==
                Ya.compatMode ? Ya.documentElement : Ya.body; var H = (new ff(la.clientWidth, la.clientHeight)).round()
        } catch (ea) { H = new ff(-12245933, -12245933) } Ya = H; H = {}; var ka = void 0 === ka ? y : ka; la = new Yh; ka.SVGElement && ka.document.createElementNS && la.set(0); A = Jh(); A["allow-top-navigation-by-user-activation"] && la.set(1); A["allow-popups-to-escape-sandbox"] && la.set(2); ka.crypto && ka.crypto.subtle && la.set(3); ka.TextDecoder && ka.TextEncoder && la.set(4); ka = Zh(la); H.bc = ka; H.bih = Ya.height; H.biw = Ya.width; H.brdim = u.join(); b = b.j; b = (H.vis =
    ...
    }, hl = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Qh)), il = !1;
    function jl(a, b) {
        b = void 0 === b ? {} : b; var c = Zk(a), d = M("web_ajax_ignore_global_headers_if_set"), e; for (e in gl) { var f = L(gl[e]); "X-Goog-Visitor-Id" !== e || f || (f = L("VISITOR_DATA")); !f || !c && oc(a) || d && void 0 !== b[e] || (b[e] = f) } "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"]; if (c || !oc(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset()); if (c || !oc(a)) { try { var g = (new Intl.DateTimeFormat).resolvedOptions().timeZone } catch (h) { } g && (b["X-YouTube-Time-Zone"] = g) } if (c ||
            !oc(a)) b["X-YouTube-Ad-Signals"] = Vk($k()); return b
    }
    function kl(a) {
        var b = window.location.search, c = oc(a); M("debug_handle_relative_url_for_query_forward_killswitch") || c || !Zk(a) || (c = document.location.hostname); var d = mc(nc(5, a)); d = (c = c && (c.endsWith("youtube.com") || c.endsWith("youtube-nocookie.com"))) && d && d.startsWith("/api/"); if (!c || d) return a; var e = Wk(b), f = {}; fb(hl, function (g) { e[g] && (f[g] = e[g]) });
        return Yk(a, f || {}, !1)
    }
    function ll(a, b) {
        var c = b.format || "JSON"; a = ml(a, b); var d = nl(a, b), e = !1, f = ol(a, function (k) { if (!e) { e = !0; h && fl(h); var m = dl(k), q = null, r = 400 <= k.status && 500 > k.status, x = 500 <= k.status && 600 > k.status; if (m || r || x) q = pl(a, c, k, b.convertToSafeHtml); if (m) a: if (k && 204 == k.status) m = !0; else { switch (c) { case "XML": m = 0 == parseInt(q && q.return_code, 10); break a; case "RAW": m = !0; break a }m = !!q } q = q || {}; r = b.context || y; m ? b.onSuccess && b.onSuccess.call(r, k, q) : b.onError && b.onError.call(r, k, q); b.onFinish && b.onFinish.call(r, k, q) } }, b.method,
    ...
    function pl(a, b, c, d) {
        var e = null; switch (b) { case "JSON": try { var f = c.responseText } catch (g) { throw d = Error("Error reading responseText"), d.params = a, Mk(d), g; } a = c.getResponseHeader("Content-Type") || ""; f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f)); break; case "XML": if (a = (a = c.responseXML) ? ql(a) : null) e = {}, fb(a.getElementsByTagName("*"), function (g) { e[g.tagName] = rl(g) }) }d && sl(e);
        return e
    }
    ...
    function ol(a, b, c, d, e, f, g) {
        function h() { 4 == (k && "readyState" in k ? k.readyState : 0) && b && Kk(b)(k) }
    ...
    ; function tl(a) {
        var b = this; this.j = void 0; this.i = !1; a.addEventListener("beforeinstallprompt", function (c) { c.preventDefault(); b.j = c });
    ...
    Na(zl); var El = { bluetooth: "CONN_DISCO", cellular: "CONN_CELLULAR_UNKNOWN", ethernet: "CONN_WIFI", none: "CONN_NONE", wifi: "CONN_WIFI", wimax: "CONN_CELLULAR_4G", other: "CONN_UNKNOWN", unknown: "CONN_UNKNOWN", "slow-2g": "CONN_CELLULAR_2G", "2g": "CONN_CELLULAR_2G", "3g": "CONN_CELLULAR_3G", "4g": "CONN_CELLULAR_4G" }, Fl = {
    ...
    function Sl(a) {
        var b = new Yi, c = new Ri; D(c, 1, a.Wb); D(c, 2, a.Vb); D(c, 16, a.Lc); D(c, 17, a.innertubeContextClientVersion); if (a.qb) { var d = a.qb, e = new Ni; d.coldConfigData && D(e, 1, d.coldConfigData); d.appInstallData && D(e, 6, d.appInstallData); d.coldHashData && D(e, 3, d.coldHashData); d.hotHashData && D(e, 5, d.hotHashData); G(c, Ni, 62, e) } (d = y.devicePixelRatio) && 1 != d && D(c, 65, d); d = Gk(); "" !== d && D(c, 54, d); d = Hk(); if (0 < d.length) {
            e = new Ti; for (var f = 0; f < d.length; f++) {
                var g = new Li; D(g, 1, d[f].key); g.setValue(d[f].value); Zd(e, 15, Li,
                    g)
            } G(b, Ti, 5, e)
        } Ol(a, c); Pl(c); Ql(a, c); Rl(c); L("DELEGATED_SESSION_ID") && !M("pageid_as_header_web") && (a = new Wi, D(a, 3, L("DELEGATED_SESSION_ID"))); a = p(Object.entries(Wk(L("DEVICE", "")))); for (d = a.next(); !d.done; d = a.next())e = p(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? D(c, 12, e) : "cmodel" === d ? D(c, 13, e) : "cbr" === d ? D(c, 87, e) : "cbrver" === d ? D(c, 88, e) : "cos" === d ? D(c, 18, e) : "cosver" === d ? D(c, 19, e) : "cplatform" === d && D(c, 42, e); b.s(c); return b
    }
    ...
    l.update = function (a) { return Um(this.cursor.update(a)) }; function ln(a, b, c) {
        return new Promise(function (d, e) {
            function f() { x || (x = new Wm(g.result, { closed: r })); return x }
            var g = void 0 !== b ? self.indexedDB.open(a, b) : self.indexedDB.open(a); var h = c.blocked, k = c.blocking, m = c.od, q = c.upgrade, r = c.closed, x; g.addEventListener("upgradeneeded", function (u) {
                try {
                    if (null === u.newVersion) throw Error("Invariant: newVersion on IDbVersionChangeEvent is null"); if (null === g.transaction) throw Error("Invariant: transaction on IDbOpenDbRequest is null"); u.dataLoss && "none" !== u.dataLoss && um("IDB_DATA_CORRUPTED", { reason: u.dataLossMessage || "unknown reason", dbName: ym(a) }); var A = f(), E = new an(g.transaction);
                    q && q(A, function (F) { return u.oldVersion < F && u.newVersion >= F }, E);
                    E.done.catch(function (F) { e(F) })
                } catch (F) { e(F) }
            });
            g.addEventListener("success", function () {
                var u = g.result; k && u.addEventListener("versionchange", function () { k(f()) });
    ...
    function nn(a, b) {
        b = void 0 === b ? {} : b; var c, d, e, f; return w(function (g) {
            if (1 == g.i) return ya(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.blocked) && c.addEventListener("blocked", function () { e() }), v(g, Tm(c), 4);
    ...
    function sn(a) {
        function b() {
            var f, g, h, k, m, q, r, x, u, A; return w(function (E) {
                switch (E.i) {
        ...
        if (!a.m) throw qn(a); if (a.i) return a.i; var d = {
            blocking: function (f) { f.close() },
            closed: c, od: c, upgrade: a.options.upgrade
    ...
    function On(a, b, c) {
        a = a.map(function (d) { return w(function (e) { return 1 == e.i ? v(e, nn(d.actualName, b), 2) : v(e, vn(d.actualName, c), 0) }) });
    ...
    l = Rn.prototype; l.writeThenSend = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (Sn(this) && this.i) {
            var d = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.O.set(d, this.H).then(function (e) { d.id = e; c.M.L() && Vn(c, d) }).catch(function (e) {
                Vn(c, d);
                Wn(c, e)
            })
        } else this.ja(a, b)
    ...
    l.sendThenWrite = function (a, b, c) {
        var d = this; b = void 0 === b ? {} : b; if (Sn(this) && this.i) {
            var e = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.I && this.I("nwl_skip_retry") && (e.skipRetry = c); if (this.M.L() || this.I && this.I("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function () { };
                    b.onError = function (g, h) {
                        return w(function (k) {
                            if (1 == k.i) return v(k, d.O.set(e, d.H).catch(function (m) { Wn(d, m) }), 2);
                            f(g, h); k.i = 0
                        })
                    }
    ...
    l.sendAndWrite = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (Sn(this) && this.i) {
            ...
            this.ja(d.url, d.options); this.O.set(d, this.H).then(function (g) { d.id = g; e && c.O.ya(d.id, c.H) }).catch(function (g) { Wn(c, g) })
        } else this.ja(a, b)
    };
    ...
    function io(a) {
        var b = jo, c = ho(); if (!c) return 0; var d = c.subscribe(b.toString(), function (e, f) {
            var g = B("ytPubsub2Pubsub2SkipSubKey"); g && g == d || (g = function () {
                if (co[d]) try {
                    if (f && b instanceof ao && b != e) try {
                        var h = b.i, k = f; if (!k.args || !k.version) throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete."); try { if (!h.oa) { var m = new h; h.oa = m.version } var q = h.oa } catch (F) { } if (!q || k.version != q) throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible."); try {
                            q = Reflect; var r = q.construct;
                            var x = k.args, u = x.length; if (0 < u) { var A = Array(u); for (k = 0; k < u; k++)A[k] = x[k]; var E = A } else E = []; f = r.call(q, h, E)
            ...
            }, fo[b.toString()] ? B("yt.scheduler.instance") ? Vh.S(g) : el(g, 0) : g())
        });
        co[d] = !0; eo[b.toString()] || (eo[b.toString()] = []); eo[b.toString()].push(d); return d
    }
    function ko() {
        var a = lo, b = io(function (c) { a.apply(void 0, arguments); mo(b) });
        return b
    }
    ...
    ; var qo;
    function ro() {
        if (qo) return qo(); var a = {}; qo = po("LogsDatabaseV2", {
    ...
    function vo(a, b) {
        var c, d, e, f, g, h, k; return w(function (m) {
            if (1 == m.i) return c = { startTime: P(), transactionType: "YT_IDB_TRANSACTION_TYPE_READ" }, v(m, so(b), 2); if (3 != m.i) return d = m.j, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, P()], h = IDBKeyRange.bound(f, g), k = void 0, v(m, Xm(d, ["LogsRequestsStore"], { mode: "readwrite", U: !0 }, function (q) {
                return jn(q.objectStore("LogsRequestsStore").index("newRequestV2"), { query: h, direction: "prev" }, function (r) {
    ...
    ; var Bo = {}, Co = po("ServiceWorkerLogsDatabase", {
        Ga: (Bo.SWHealthLog = { hb: 1 }, Bo), Ab: !0, upgrade: function (a, b) { b(1) && Ym(a, "SWHealthLog", { keyPath: "id", autoIncrement: !0 }).i.createIndex("swHealthNewRequest", ["interface", "timestamp"], { unique: !1 }) },
        version: 1
    }); function Do(a) { return rn(Co(), a) }
    ...
    ; var Go = {}, Ho = 0;
    function Io(a) {
        var b = void 0 === b ? "" : b; var c = void 0 === c ? !1 : c; if (a) if (b) ol(a, void 0, "POST", b); else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) ol(a, void 0, "GET", "", void 0, void 0, c); else {
            b: { try { var d = new bb({ url: a }); if (d.l && d.j || d.m) { var e = mc(nc(5, a)), f; if (!(f = !e || !e.endsWith("/aclk"))) { var g = a.search(Bc), h = xc(a, 0, "ri", g); if (0 > h) var k = null; else { var m = a.indexOf("&", h); if (0 > m || m > g) m = g; k = decodeURIComponent(a.slice(h + 3, -1 !== m ? m : 0).replace(/\+/g, " ")) } f = "1" !== k } var q = !f; break b } } catch (x) { } q = !1 } if (q) {
                b: {
                    try {
                        if (window.navigator &&
                            window.navigator.sendBeacon && window.navigator.sendBeacon(a, "")) { var r = !0; break b }
                    } catch (x) { } r = !1
                } b = r ? !0 : !1
            } else b = !1; b || Jo(a)
        }
    ...
    l.Ia = function (a) {
        a = Sh(this.j, a); a.then(function (b) { M("use_cfr_monitor") && Lo().requestComplete("generate_204", b) });
        return a
    };
    ...
    t(Uo, Rn); function Yo() {
        var a = B("yt.networklessRequestController.instance"); a || (a = new Uo, z("yt.networklessRequestController.instance", a), M("networkless_logging") && Fn().then(function (b) { a.H = b; Tn(a); a.l.resolve(); a.Va && Math.random() <= a.Ta && a.H && Eo(a.H); M("networkless_immediately_drop_sw_health_store") && Zo(a) }));
        return a
    }
    ...
    function lp(a, b) {
        function c(d) {
            var e = hp().L(); if (!mp() || !d || e && M("vss_networkless_bypass_write")) np(a, b); else {
                var f = { url: a, options: b, timestamp: P(), status: "NEW", sendCount: 0 }; to(f, d).then(function (g) { f.id = g; hp().L() && op(f) }).catch(function (g) {
                    op(f);
                    hp().L() ? Lk(g) : Oo(g)
                })
            }
    ...
    function pp(a, b) {
        function c(d) {
            if (mp() && d) {
                var e = { url: a, options: b, timestamp: P(), status: "NEW", sendCount: 0 }, f = !1, g = b.onSuccess ? b.onSuccess : function () { };
                ...
                if (M("use_cfr_monitor")) {
                    ...
                    e.options.onError = function (k, m) { Lo().requestComplete(e.url, !1); h(k, m) }
                } np(e.url, e.options);
                to(e, d).then(function (k) { e.id = k; f && yo(e.id, d) }).catch(function (k) { hp().L() ? Lk(k) : Oo(k) })
            } else np(a, b)
        }
        b = void 0 === b ? {} : b; M("skip_is_supported_killswitch") ? Fn().then(function (d) { c(d) }) : c(En())
    }
    ...
    function op(a) {
        var b, c, d; return w(function (e) {
            switch (e.i) {
                case 1: b = En(); if (!b) throw c = Km("immediateSend"), c; if (void 0 === a.id) { e.u(2); break } return v(e, wo(a.id, b), 3); case 3: (d = e.j) ? a = d : Mk(Error("The request cannot be found in the database.")); case 2: if (qp(a, 2592E6)) { e.u(4); break } Mk(Error("Networkless Logging: Stored logs request expired age limit")); if (void 0 === a.id) { e.u(5); break } return v(e, yo(a.id, b), 5); case 5: return e.return(); case 4: a.skipRetry || (a = Ep(a)); var f = a; if (M("use_request_time_ms_header")) {
                    var g;
                    if (null == f ? 0 : null == (g = f.options) ? 0 : g.headers) f.options.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(P()))
                } else { var h, k; if (null == f ? 0 : null == (h = f.options) ? 0 : null == (k = h.postParams) ? 0 : k.requestTimeMs) f.options.postParams.requestTimeMs = Math.round(P()) } a = f; if (!a) { e.u(0); break } if (!a.skipRetry || void 0 === a.id) { e.u(8); break } return v(e, yo(a.id, b), 8); case 8: np(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    function Ep(a) {
        var b = En(); if (!b) throw Km("updateRequestHandlers"); var c = a.options.onError ? a.options.onError : function () { };
        a.options.onError = function (e, f) {
            var g, h, k; return w(function (m) {
                switch (m.i) {
                    case 1: M("use_cfr_monitor") && Lo().requestComplete(a.url, !1); g = Zn(f); if (!(M("nwl_consider_error_code") && g || !M("nwl_consider_error_code") && cq() <= Fk("potential_esf_error_limit", 10))) { m.u(2); break } if (M("skip_checking_network_on_cfr_failure") && (!M("skip_checking_network_on_cfr_failure") || Lo().isEndpointCFR(a.url))) { m.u(3); break } return v(m, hp().Ia(), 3); case 3: if (hp().L()) { m.u(2); break } c(e, f); if (!M("nwl_consider_error_code") || void 0 ===
    ...
    function bm(a, b, c, d) {
        function e(A) {
            A = void 0 === A ? !1 : A; var E; if (d.retry && "www.youtube-nocookie.com" != h && (A || M("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (E = Zl(b, c, m, k)), E)) {
                var F = g.onSuccess, O = g.onFetchSuccess; g.onSuccess = function (N, R) { $l(E); F(N, R) };
                c.onFetchSuccess = function (N, R) { $l(E); O(N, R) }
            } try { A && d.retry && !d.Yb.bypassNetworkless ? (g.method = "POST", d.Yb.writeThenSend ? M("use_new_nwl_wts") ? Yo().writeThenSend(u, g) : lp(u, g) : M("use_new_nwl_saw") ? Yo().sendAndWrite(u, g) : pp(u, g)) : M("web_all_payloads_via_jspb") ? ll(u, g) : (g.method = "POST", g.postParams || (g.postParams = {}), ll(u, g)) } catch (N) {
                if ("InvalidAccessError" == N.name) E && ($l(E), E = 0), Mk(Error("An extension is blocking network request."));
                else throw N;
            } E && dm(function () { am(a) }, 0, 5E3)
        }
        !L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Mk(new Q("Missing VISITOR_DATA when sending innertube request.", b, c, d)); if (!a.isReady()) { var f = new Q("innertube xhrclient not ready", b, c, d); Lk(f); throw f; } var g = {
    ...
    function hq(a) {
        this.type = ""; this.state = this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.rotation = this.clientY = this.clientX = 0; this.scale = 1; this.changedTouches = this.touches = null; try {
            if (a = a || window.event) {
                this.event = a; for (var b in a) b in gq || (this[b] = a[b]); this.scale = a.scale; this.rotation = a.rotation; var c = a.target || a.srcElement; c && 3 == c.nodeType && (c = c.parentNode); this.target = c; var d = a.relatedTarget;
    ...
    function mq(a, b, c, d) {
        d = void 0 === d ? {} : d; if (!a || !a.addEventListener && !a.attachEvent) return ""; var e = kq(a, b, c, d); if (e) return e; e = ++jq.count + ""; var f = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document); var g = f ? function (h) { h = new hq(h); if (!jf(h.relatedTarget, function (k) { return k == a })) return h.currentTarget = a, h.type = b, c.call(a, h) } : function (h) {
            h = new hq(h);
    ...
    function rq(a) {
        var b = void 0 === a ? {} : a; a = void 0 === b.Uc ? !1 : b.Uc; b = void 0 === b.Gc ? !0 : b.Gc; if (null == B("_lact", window)) {
            var c = parseInt(L("LACT"), 10); c = isFinite(c) ? Date.now() - Math.max(c, 0) : -1; z("_lact", c, window); z("_fact", c, window); -1 == c && sq(); mq(document, "keydown", sq); mq(document, "keyup", sq); mq(document, "mousedown", sq); mq(document, "mouseup", sq); a ? mq(window, "touchmove", function () { tq("touchmove", 200) }, { passive: !0 }) : (mq(window, "resize", function () { tq("resize", 200) }), b && mq(window, "scroll", function () { tq("scroll", 200) }));
    ...
    ; var vq = y.ytPubsubPubsubInstance || new K, wq = y.ytPubsubPubsubSubscribedKeys || {}, xq = y.ytPubsubPubsubTopicToKeys || {}, yq = y.ytPubsubPubsubIsSynchronous || {}; function zq(a, b) {
        var c = Aq(); if (c && b) {
            var d = c.subscribe(a, function () {
                var e = arguments; var f = function () { wq[d] && b.apply && "function" == typeof b.apply && b.apply(window, e) };
                try { yq[a] ? f() : el(f, 0) } catch (g) { Lk(g) }
            }, void 0);
            wq[d] = !0; xq[a] || (xq[a] = []); xq[a].push(d); return d
        } return 0
    }
    ...
    Fq.prototype.extractMatchingEntries = function (a) {
    ...
    function Uq() {
        var a = B("yt.logging.ims"); a || (a = new Fq({ maxBatchSize: Fk("tvhtml5_logging_max_batch") || Fk("web_logging_max_batch") || 100, onBatchSizeExceeded: function (b) { Vq({ writeThenSend: !0 }, void 0, b.isJspb) } }), z("yt.logging.ims", a));
        return a
    }
    ...
    function Vq(a, b, c) {
        a = void 0 === a ? {} : a; c = void 0 === c ? !1 : c; !c && M("web_all_payloads_via_jspb") && Mk(new Q("transport.flushLogs called for JSON in JSPB only experiment")); new wf(function (d, e) {
            c ? (fl(Nq.j), fl(Nq.i), Nq.i = 0) : (fl(Mq.j), fl(Mq.i), Mq.i = 0); if (Kq && Kq.isReady()) if (M("use_new_in_memory_storage")) {
                var f = a, g = c, h = Kq; f = void 0 === f ? {} : f; g = void 0 === g ? !1 : g; var k = new Map, m = new Map; if (void 0 !== b) g ? (e = Uq().extractMatchingEntries({ isJspb: g, cttAuthInfo: b }), k.set(b, e), er(k, h, d, f)) : (k = Uq().extractMatchingEntries({
                    isJspb: g,
                    cttAuthInfo: b
                }), m.set(b, k), cr(m, h, d, e, f)); else if (g) { e = p(Object.keys(Tq)); for (g = e.next(); !g.done; g = e.next())m = g.value, g = Uq().extractMatchingEntries({ isJspb: !0, cttAuthInfo: m }), 0 < g.length && k.set(m, g), delete Tq[m]; er(k, h, d, f) } else { k = p(Object.keys(Tq)); for (g = k.next(); !g.done; g = k.next()) { g = g.value; var q = Uq().extractMatchingEntries({ isJspb: !1, cttAuthInfo: g }); 0 < q.length && m.set(g, q); delete Tq[g] } cr(m, h, d, e, f) }
            } else f = a, k = c, h = Kq, f = void 0 === f ? {} : f, k = void 0 === k ? !1 : k, void 0 !== b ? k ? (e = new Map, k = Qq.get(b) || [], e.set(b,
    ...
    function ar(a) {
        a = void 0 === a ? !1 : a; if (M("web_gel_timeout_cap") && (!a && !Mq.i || a && !Nq.i)) {
            var b = el(function () { Vq({ writeThenSend: !0 }, void 0, a) }, 6E4);
            a ? Nq.i = b : Mq.i = b
        } fl(a ? Nq.j : Mq.j); b = L("LOGGING_BATCH_TIMEOUT", Fk("web_gel_debounce_ms", 1E4)); M("shorten_initial_gel_batch_timeout") && Oq && (b = Iq); b = el(function () { Vq({ writeThenSend: !0 }, void 0, a) }, b);
        a ? Nq.j = b : Mq.j = b
    }
    function cr(a, b, c, d, e, f) {
        e = void 0 === e ? {} : e; var g = Math.round(P()), h = a.size; a = p(a); for (var k = a.next(); !k.done; k = a.next()) {
            var m = p(k.value); k = m.next().value; var q = m.next().value; m = k; k = wb({ context: Nl(b.config_ || Ml()) }); if (!Pa(q) && !M("throw_err_when_logevent_malformed_killswitch")) { d(); break } k.events = q; (q = Rq[m]) && fr(k, m, q); delete Rq[m]; m = "visitorOnlyApprovedKey" === m; gr(k, g, m); hr(e); q = function () { h--; h || c() };
            var r = function () { h--; h || c() };
            try { bm(b, "log_event", k, ir(e, m, q, r, f)), Oq = !1 } catch (x) { Lk(x), d() }
        }
    }
    function er(a, b, c, d, e) {
        d = void 0 === d ? {} : d; var f = Math.round(P()), g = a.size, h = new Map([].concat(ia(a))); h = p(h); for (var k = h.next(); !k.done; k = h.next()) {
            var m = p(k.value).next().value, q = a.get(m); k = new qk; var r = Sl(b.config_ || Ml()); G(k, Yi, 1, r); q = q ? jr(q) : []; q = p(q); for (r = q.next(); !r.done; r = q.next())Zd(k, 3, Qj, r.value); (q = Sq[m]) && kr(k, m, q); delete Sq[m]; m = "visitorOnlyApprovedKey" === m; lr(k, f, m); hr(d); k = be(k); m = ir(d, m, function () { g--; g || c() }, function () {
                g--;
                g || c()
            }, e);
    ...
    ; var Br = [{
        tb: function (a) { return "Cannot read property '" + a.key + "'" },
        Za: {
        ...
        tb: function (a) { return "Cannot call '" + a.key + "'" },
        Za: {
        ...
        tb: function (a) { return a.key + " is not defined" },
        Za: { ReferenceError: [{ regexp: /(.*) is not defined/, groups: ["key"] }, { regexp: /Can't find variable: (.*)/, groups: ["key"] }] }
    }]; var Dr = { na: [], ma: [{ callback: Cr, weight: 500 }] }; function Cr(a) { if ("JavaException" === a.name) return !0; a = a.stack; return a.includes("chrome://") || a.includes("chrome-extension://") || a.includes("moz-extension://") }
            ...
            a.hasOwnProperty("level") && a.level && (h = a.level); if (M("console_log_js_exceptions")) {
                ...
                var m = Rr, q = se(a), r = q.message || "Unknown Error", x = q.name || "UnknownError", u = q.stack || a.j || "Not available"; if (u.startsWith(x + ": " + r)) { var A = u.split("\n"); A.shift(); u = A.join("\n") } var E = q.lineNumber || "Not available", F = q.fileName || "Not available", O = u, N = 0; if (a.hasOwnProperty("args") && a.args && a.args.length) for (var R = 0; R < a.args.length && !(N = Kr(a.args[R], "params." + R, g, N), 500 <= N); R++); else if (a.hasOwnProperty("params") &&
                    a.params) { var ca = a.params; if ("object" === typeof a.params) for (var W in ca) { if (ca[W]) { var ob = "params." + W, Ya = Mr(ca[W]); g[ob] = Ya; N += ob.length + Ya.length; if (500 < N) break } } else g.params = Mr(ca) } if (m.length) for (var la = 0; la < m.length && !(N = Kr(m[la], "params.context." + la, g, N), 500 <= N); la++); navigator.vendor && !g.hasOwnProperty("vendor") && (g["device.vendor"] = navigator.vendor); var H = { message: r, name: x, lineNumber: E, fileName: F, stack: O, params: g, sampleWeight: 1 }, ka = Number(a.columnNumber); isNaN(ka) || (H.lineNumber = H.lineNumber +
                        ":" + ka); if ("IGNORED" === a.level) var ea = 0; else a: { for (var Ae = Gr(), Be = p(Ae.na), wd = Be.next(); !wd.done; wd = Be.next()) { var na = wd.value; if (H.message && H.message.match(na.Mq)) { ea = na.weight; break a } } for (var rp = p(Ae.ma), Sj = rp.next(); !Sj.done; Sj = rp.next()) { var sp = Sj.value; if (sp.callback(H)) { ea = sp.weight; break a } } ea = 1 } H.sampleWeight = ea; for (var tp = p(Br), Tj = tp.next(); !Tj.done; Tj = tp.next()) {
                            var Uj = Tj.value; if (Uj.Za[H.name]) for (var up = p(Uj.Za[H.name]), Vj = up.next(); !Vj.done; Vj = up.next()) {
                                var vp = Vj.value, Qg = H.message.match(vp.regexp);
                                if (Qg) { H.params["params.error.original"] = Qg[0]; for (var Wj = vp.groups, wp = {}, xd = 0; xd < Wj.length; xd++)wp[Wj[xd]] = Qg[xd + 1], H.params["params.error." + Wj[xd]] = Qg[xd + 1]; H.message = Uj.tb(wp); break }
                            }
                        } H.params || (H.params = {}); var xp = Gr(); H.params["params.errorServiceSignature"] = "msg=" + xp.na.length + "&cb=" + xp.ma.length; H.params["params.serviceWorker"] = "false"; y.document && y.document.querySelectorAll && (H.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)); Db("sample").constructor !==
                            Bb && (H.params["params.fconst"] = "true"); window.yterr && "function" === typeof window.yterr && window.yterr(H); if (0 !== H.sampleWeight && !Nr.has(H.message)) {
                                if ("ERROR" === h) {
                                    Hr.qa("handleError", H); if (M("record_app_crashed_web") && 0 === Qr && 1 === H.sampleWeight) if (Qr++, M("errors_via_jspb")) {
                                        var Xj = new pj; D(Xj, 1, 1); if (!M("report_client_error_with_app_crash_ks")) { var yp = new kj; D(yp, 1, H.message); var zp = new lj; G(zp, kj, 3, yp); var Ap = new mj; G(Ap, lj, 5, zp); var Bp = new nj; G(Bp, mj, 9, Ap); G(Xj, nj, 4, Bp) } var Cp = new Qj; Xd(Cp, pj, 20,
                                            Rj, Xj); tr(Cp)
                                    } else { var Dp = { appCrashType: "APP_CRASH_TYPE_BREAKPAD" }; M("report_client_error_with_app_crash_ks") || (Dp.systemHealth = { crashData: { clientError: { logMessage: { message: H.message } } } }); sm("appCrashed", Dp) } Pr++
                                } else "WARNING" === h && Hr.qa("handleWarning", H); if (M("kevlar_gel_error_routing")) a: {
                                    var Ce = h; if (M("errors_via_jspb")) {
                                        if (Vr()) var Fp = void 0; else {
                                            var yd = new hj; D(yd, 1, H.stack); H.fileName && D(yd, 4, H.fileName); var Jb = H.lineNumber && H.lineNumber.split ? H.lineNumber.split(":") : []; 0 !== Jb.length && (1 !==
                                            ...
                                            if (!Dk() && ak) for (var Hp = p(Object.keys(ak)), zc = Hp.next(); !zc.done; zc = Hp.next()) { var Ip = zc.value, bk = new gj; D(bk, 1, Ip); bk.setValue(String(ak[Ip])); Zd(bc, 4, gj, bk) } var ck = H.params; if (ck) { var Jp = p(Object.keys(ck)); for (zc = Jp.next(); !zc.done; zc = Jp.next()) { var Kp = zc.value, dk = new gj; D(dk, 1, "client." + Kp); dk.setValue(String(ck[Kp])); Zd(bc, 4, gj, dk) } } var Lp = L("SERVER_NAME"), Mp = L("SERVER_VERSION"); if (Lp && Mp) {
                                                var ek = new gj; D(ek, 1, "server.name"); ek.setValue(Lp); Zd(bc, 4, gj, ek); var fk = new gj; D(fk, 1, "server.version");
                                                fk.setValue(Mp); Zd(bc, 4, gj, fk)
                                            } var Rg = new lj; G(Rg, ej, 1, bc); G(Rg, ij, 2, Yj); G(Rg, kj, 3, yc); Fp = Rg
                                        } var Np = Fp; if (!Np) break a; var Op = new Qj; Xd(Op, lj, 163, Rj, Np); tr(Op)
                                    } else {
                                        if (Vr()) var Pp = void 0; else {
                                            var De = { stackTrace: H.stack }; H.fileName && (De.filename = H.fileName); var Kb = H.lineNumber && H.lineNumber.split ? H.lineNumber.split(":") : []; 0 !== Kb.length && (1 !== Kb.length || isNaN(Number(Kb[0])) ? 2 !== Kb.length || isNaN(Number(Kb[0])) || isNaN(Number(Kb[1])) || (De.lineNumber = Number(Kb[0]), De.columnNumber = Number(Kb[1])) : De.lineNumber =
                                                Number(Kb[0])); var gk = { level: "ERROR_LEVEL_UNKNOWN", message: H.message, errorClassName: H.name, sampleWeight: H.sampleWeight }; "ERROR" === Ce ? gk.level = "ERROR_LEVEL_ERROR" : "WARNING" === Ce && (gk.level = "ERROR_LEVEL_WARNNING"); var Pv = { isObfuscated: !0, browserStackInfo: De }, zd = { pageUrl: window.location.href, kvPairs: [] }; L("FEXP_EXPERIMENTS") && (zd.experimentIds = L("FEXP_EXPERIMENTS")); var hk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (!Dk() && hk) for (var Qp = p(Object.keys(hk)), Ac = Qp.next(); !Ac.done; Ac = Qp.next()) {
                                                    var Rp =
                                                        Ac.value; zd.kvPairs.push({ key: Rp, value: String(hk[Rp]) })
                                                } var ik = H.params; if (ik) { var Sp = p(Object.keys(ik)); for (Ac = Sp.next(); !Ac.done; Ac = Sp.next()) { var Tp = Ac.value; zd.kvPairs.push({ key: "client." + Tp, value: String(ik[Tp]) }) } } var Up = L("SERVER_NAME"), Vp = L("SERVER_VERSION"); Up && Vp && (zd.kvPairs.push({ key: "server.name", value: Up }), zd.kvPairs.push({ key: "server.version", value: Vp })); Pp = { errorMetadata: zd, stackTrace: Pv, logMessage: gk }
                                        } var Wp = Pp; if (!Wp) break a; sm("clientError", Wp)
                                    ...
                                    } else { if (M("web_fp_via_jspb") && (qr(!0), !M("web_fp_via_jspb_and_json"))) break b; qr() }
                                } if (!M("suppress_error_204_logging")) {
                                    var Ee = H.params || {}, cc = { urlParams: { a: "logerror", t: "jserror", type: H.name, msg: H.message.substr(0, 250), line: H.lineNumber, level: h, "client.name": Ee.name }, postParams: { url: L("PAGE_NAME", window.location.href), file: H.fileName }, method: "POST" }; Ee.version && (cc["client.version"] = Ee.version); if (cc.postParams) {
                                        H.stack && (cc.postParams.stack =
                                            H.stack); for (var Xp = p(Object.keys(Ee)), jk = Xp.next(); !jk.done; jk = Xp.next()) { var Yp = jk.value; cc.postParams["client." + Yp] = Ee[Yp] } var kk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (kk) for (var Zp = p(Object.keys(kk)), lk = Zp.next(); !lk.done; lk = Zp.next()) { var $p = lk.value; cc.postParams[$p] = kk[$p] } var aq = L("SERVER_NAME"), bq = L("SERVER_VERSION"); aq && bq && (cc.postParams["server.name"] = aq, cc.postParams["server.version"] = bq)
                                    } ll(L("ECATCHER_REPORT_HOST", "") + "/error_204", cc)
                                } try { Nr.add(H.message) } catch (ox) { } Or++
                            }
            }
        }
    }
    ...
    ; var rs = {
        ...
        cq: 55759, fq: 64031, lq: 93044, mq: 93045, nq: 34388, oq: 17657, pq: 17655, qq: 39579, rq: 39578, sq: 77448, tq: 8196, uq: 11357, wq: 69877, xq: 8197, yq: 156512, zq: 156509, Aq: 82039
    }; function ss() {
        var a = vb(ts), b; return (new wf(function (c, d) {
    ...
    function Ok() {
        var a = Gs(); if (void 0 !== a) return Bf(a); Fs || (Fs = ss().then(Hs).eb(function (b) { return Is(2, b) }));
        return Fs
    }
    ...
    function kt(a) {
        var b = void 0 === b ? "UNKNOWN_INTERFACE" : b; if (1 === a.length) return a[0]; var c = jt[b]; if (c) { var d = new RegExp(c), e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, d.exec(c)) return c } var f = []; Object.entries(jt).forEach(function (g) { var h = p(g); g = h.next().value; h = h.next().value; b !== g && f.push(h) });
        d = new RegExp(f.join("|")); a.sort(function (g, h) { return g.length - h.length });
        e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, !d.exec(c)) return c; return a[0]
    }
    ; function lt() { }
    lt.prototype.o = function (a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? Os : c; var d = a.clickTrackingParams, e = this.m, f = !1; f = void 0 === f ? !1 : f; e = void 0 === e ? !1 : e; var g = L("INNERTUBE_CONTEXT"); if (g) {
            g = wb(g); M("web_no_tracking_params_in_shell_killswitch") || delete g.clickTracking; g.client || (g.client = {}); var h = g.client; "MWEB" === h.clientName && (h.clientFormFactor = L("IS_TABLET") ? "LARGE_FORM_FACTOR" : "SMALL_FORM_FACTOR"); h.screenWidthPoints = window.innerWidth; h.screenHeightPoints = window.innerHeight; h.screenPixelDensity = Math.round(window.devicePixelRatio ||
                1); h.screenDensityFloat = window.devicePixelRatio || 1; h.utcOffsetMinutes = -Math.floor((new Date).getTimezoneOffset()); var k = void 0 === k ? !1 : k; zl.getInstance(); var m = "USER_INTERFACE_THEME_LIGHT"; Cl(165) ? m = "USER_INTERFACE_THEME_DARK" : Cl(174) ? m = "USER_INTERFACE_THEME_LIGHT" : !M("kevlar_legacy_browsers") && window.matchMedia && window.matchMedia("(prefers-color-scheme)").matches && window.matchMedia("(prefers-color-scheme: dark)").matches && (m = "USER_INTERFACE_THEME_DARK"); k = k ? m : Qs() || m; h.userInterfaceTheme = k; if (!f) {
                    if (k =
                        Jl()) h.connectionType = k; M("web_log_effective_connection_type") && (k = Kl()) && (g.client.effectiveConnectionType = k)
                    ...
                    tl.i && (r = tl.i, h.mainAppWebInfo.pwaInstallabilityStatus = !r.i && r.j ? "PWA_INSTALLABILITY_STATUS_CAN_BE_INSTALLED" : "PWA_INSTALLABILITY_STATUS_UNKNOWN"), h.mainAppWebInfo.webDisplayMode = ul(), h.mainAppWebInfo.isWebNativeShareAvailable = navigator && void 0 !== navigator.share) : "TVHTML5" === h.clientName && (!M("web_lr_app_quality_killswitch") && (r = L("LIVING_ROOM_APP_QUALITY")) && (h.tvAppInfo = Object.assign(h.tvAppInfo || {}, { appQuality: r })), r = L("LIVING_ROOM_CERTIFICATION_SCOPE")) && (h.tvAppInfo = Object.assign(h.tvAppInfo ||
                        {}, { certificationScope: r })); if (!M("web_populate_time_zone_itc_killswitch")) { b: { if ("undefined" !== typeof Intl) try { var x = (new Intl.DateTimeFormat).resolvedOptions().timeZone; break b } catch (ob) { } x = void 0 } x && (h.timeZone = x) } (x = Gk()) ? h.experimentsToken = x : delete h.experimentsToken; x = Hk(); Rs.i || (Rs.i = new Rs); h = Rs.i.i; r = []; q = 0; for (var u in h) r[q++] = h[u]; g.request = Object.assign({}, g.request, { internalExperimentFlags: x, consistencyTokenJars: r }); !M("web_prequest_context_killswitch") && (u = L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT")) &&
                            (g.request.externalPrequestContext = u); x = zl.getInstance(); u = Cl(58); x = x.get("gsml", ""); g.user = Object.assign({}, g.user); u && (g.user.enableSafetyMode = u); x && (g.user.lockedSafetyMode = !0); M("warm_op_csn_cleanup") ? e && (f = ls()) && (g.clientScreenNonce = f) : !f && (f = ls()) && (g.clientScreenNonce = f); d && (g.clickTracking = { clickTrackingParams: d }); if (d = B("yt.mdx.remote.remoteClient_")) g.remoteClient = d; M("web_enable_client_location_service") && Us.getInstance().setLocationOnInnerTubeContext(g); try {
                                var A = $k(), E = A.bid; delete A.bid;
                                g.adSignalsInfo = { params: [], bid: E }; var F = p(Object.entries(A)); for (var O = F.next(); !O.done; O = F.next()) { var N = p(O.value), R = N.next().value, ca = N.next().value; A = R; E = ca; d = void 0; null == (d = g.adSignalsInfo.params) || d.push({ key: A, value: "" + E }) }
                            } catch (ob) { Tr(ob) } F = g
        } else Tr(Error("Error: No InnerTubeContext shell provided in ytconfig.")), F = {}; F = { context: F }; if (O = this.i(a)) {
            this.j(F, O, b); var W; b = "/youtubei/v1/" + kt(this.l()); (O = null == (W = zs(a.commandMetadata, bj)) ? void 0 : W.apiUrl) && (b = O); W = b; (b = L("INNERTUBE_HOST_OVERRIDE")) &&
                (W = String(b) + String(pc(W))); b = {}; b.key = L("INNERTUBE_API_KEY"); M("json_condensed_response") && (b.prettyPrint = "false"); W = Yk(W, b || {}, !1); a = M("kevlar_response_command_processor_page") ? Object.assign({}, { command: a }, void 0) : Object.assign({}, void 0); a = { input: W, ta: As(W), ha: F, config: a }; a.config.Pa ? a.config.Pa.identity = c : a.config.Pa = { identity: c }; return a
    ...
    mt.prototype.j = function () { }; var nt = {}, ot = (nt.GET_DATASYNC_IDS = gt(mt), nt); function pt(a) {
        var b = Ja.apply(1, arguments); if (!qt(a) || b.some(function (d) { return !qt(d) })) throw Error("Only objects may be merged.");
    ...
    t(ut, $n); var vt = new ao("aft-recorded", ut); var wt = window; function xt() {
    ...
    var S = wt.performance || wt.mozPerformance || wt.msPerformance || wt.webkitPerformance || new xt; var zt = !1, At = {
    ...
    ; function Ot() {
        if (S.getEntriesByType) { var a = S.getEntriesByType("paint"); if (a = kb(a, function (b) { return "first-paint" === b.name })) return Et(a.startTime) } a = S.timing;
    ...
    ; var V = {
        ...
        LATENCY_ACTION_ONBOARDING: 135, LATENCY_ACTION_LOGIN: 97, LATENCY_ACTION_BROWSE: 11, LATENCY_ACTION_CHANNELS: 4, LATENCY_ACTION_WATCH: 3, LATENCY_ACTION_RESULTS: 2, LATENCY_ACTION_HOME: 1, LATENCY_ACTION_STARTUP: 106, LATENCY_ACTION_UNKNOWN: 0
    }; V[V.LATENCY_ACTION_SHORTS_VIDEO_INGESTION_TRANSCODING] = "LATENCY_ACTION_SHORTS_VIDEO_INGESTION_TRANSCODING"; V[V.LATENCY_ACTION_KIDS_PROFILE_SWITCHER] = "LATENCY_ACTION_KIDS_PROFILE_SWITCHER"; V[V.LATENCY_ACTION_OFFLINE_THUMBNAIL_TRANSFER] = "LATENCY_ACTION_OFFLINE_THUMBNAIL_TRANSFER";
    ...
    function ku(a, b) {
        hu[b] = hu[b] || { count: 0 }; var c = hu[b]; c.count++; c.time = P(); a.i || (a.i = dm(function () { var d = P(), e; for (e in hu) hu[e] && 6E4 < d - hu[e].time && delete hu[e]; a && (a.i = 0) }, 0, 5E3));
    ...
    ; function lu() {
        var a = ["ol"]; Qt("").info.actionType = "embed"; a && Ck("TIMING_AFT_KEYS", a); Ck("TIMING_ACTION", "embed"); if (M("web_csi_via_jspb")) {
            a = L("TIMING_INFO", {}); var b = new Jj; a = p(Object.entries(a)); for (var c = a.next(); !c.done; c = a.next()) {
                var d = p(c.value); c = d.next().value; d = d.next().value; switch (c) {
                    case "GetBrowse_rid": var e = new Mj; D(e, 1, c); D(e, 2, String(d)); Lj(b, e); break; case "GetGuide_rid": e = new Mj; D(e, 1, c); D(e, 2, String(d)); Lj(b, e); break; case "GetHome_rid": e = new Mj; D(e, 1, c); D(e, 2, String(d)); Lj(b, e);
            ...
            } mu(b); b = new Jj; b = D(b, 25, !0); b = D(b, 1, V[Xt(L("TIMING_ACTION"))]); (a = L("PREVIOUS_ACTION")) &&
            ...
            a = pu(); if (0 < a.length) for (a = p(a), c = a.next(); !c.done; c = a.next())c = c.value, d = new Ij, D(d, 1, c), Zd(b, 83, Ij, d); mu(b)
        } else {
            a = L("TIMING_INFO", {}); for (b in a) a.hasOwnProperty(b) && qu(b, a[b]); b = { isNavigation: !0, actionType: Xt(L("TIMING_ACTION")) }; if (a = L("PREVIOUS_ACTION")) b.previousAction = Xt(a); if (a = L("CLIENT_PROTOCOL")) b.httpProtocol = a; if (a = L("CLIENT_TRANSPORT")) b.transportProtocol = a; (a = ls()) && "UNDEFINED_CSN" !== a && (b.clientScreenNonce = a); a = nu(); if (1 === a || -1 === a) b.isVisible = !0; a = Ht(); b.loadType = "cold"; ou(a); a =
                pu(); if (0 < a.length) for (b.resourceInfo = [], a = p(a), c = a.next(); !c.done; c = a.next())b.resourceInfo.push({ resourceCache: c.value }); ru(b)
        } b = Ht(); a = Jt(); if ("cold" === b.yt_lt || "cold" === a.loadType) { c = Ct(); d = It(); d = d.gelTicks ? d.gelTicks : d.gelTicks = {}; for (var m in c) m in d || Z(m, c[m]); m = {}; c = !1; d = p(Object.keys(b)); for (e = d.next(); !e.done; e = d.next())e = e.value, (e = Yt(e, b[e])) && !Nt(Jt(), e) && (pt(a, e), pt(m, e), c = !0); c && ru(m) } z("ytglobal.timingready_", !0); m = L("TIMING_ACTION"); B("ytglobal.timingready_") && m && "_start" in Ct() &&
            Bt() && Mt()
    }
    function qu(a, b, c, d) { null !== b && (Ht(c)[a] = b, (a = Yt(a, b, c)) && ru(a, c, d)) }
    function ru(a, b, c) {
        if (!M("web_csi_via_jspb") || (void 0 === c ? 0 : c)) c = Qt(b || ""), pt(c.info, a), pt(Jt(b), a), c = Lt(b), b = Gt(b).cttAuthInfo, ju().info(a, c, b); else {
            c = new Jj; var d = Object.keys(a); a = Object.values(a); for (var e = 0; e < d.length; e++) {
                var f = d[e]; try {
                    switch (f) {
                        case "actionType": D(c, 1, V[a[e]]); break; case "clientActionNonce": D(c, 2, a[e]); break; case "clientScreenNonce": D(c, 4, a[e]); break; case "loadType": D(c, 3, a[e]); break; case "isPrewarmedLaunch": D(c, 92, a[e]); break; case "isFirstInstall": D(c, 55, a[e]); break; case "networkType": D(c,
                        ...
                        case "getPlayerRequestId": D(c, 61, a[e]); break; case "getWatchNextRequestId": D(c, 62, a[e]); break; case "getBrowseRequestId": D(c, 63, a[e]); break; case "getLibraryRequestId": D(c, 66, a[e]); break; default: gu.includes(f) && Lk(new Q("Codegen laipb translator asked to translate message field", "" + f))
                    }
                } catch (g) { Lk(Error("Codegen laipb translator failed to set " + f)) }
            } mu(c, b)
        }
    }
    function mu(a, b) { Kt(b).push(be(a)); Qt(b || "").jspbInfo.push(a); var c = Lt(b); b = Gt(b).cttAuthInfo; ju().jspbInfo(a, c, b) }
    function Z(a, b, c) {
        if (!b && "_" !== a[0]) { var d = a; S.mark && (0 == d.lastIndexOf("mark_", 0) || (d = "mark_" + d), c && (d += " (" + c + ")"), S.mark(d)) } d = Qt(c || ""); d.tick[a] = b || P(); if (d.callback && d.callback[a]) { d = p(d.callback[a]); for (var e = d.next(); !e.done; e = d.next())e = e.value, e() } d = It(c); d.gelTicks && (d.gelTicks[a] = !0); d = Ct(c); e = b || P(); d[a] = e; e = Lt(c); var f = Gt(c).cttAuthInfo; if ("_start" === a) {
            var g = ju(); ku(g, "baseline_" + e) || (b = { timestamp: b, cttAuthInfo: f }, M("web_csi_via_jspb") ? (f = new Hj, D(f, 1, e), e = new Qj, Xd(e, Hj, 6, Rj, f), tr(e,
                b)) : sm("latencyActionBaselined", { clientActionNonce: e }, b))
        } else ju().tick(a, e, b, f); Mt(c); return d[a]
    }
    ...
    function zu(a, b, c, d) {
        if (void 0 !== yu.i) {
            if (d = yu.i, a = [a !== d.o, b !== d.M, c !== d.m, !1, !1, void 0 !== d.j], a.some(function (e) { return e })) throw new Q("InnerTubeTransportService is already initialized", a);
        } else yu.i = new yu(a, b, c, d)
    }
    function Au(a) {
        var b = { signalServiceEndpoint: { signal: "GET_DATASYNC_IDS" } }; var c = void 0 === c ? Os : c; var d = Xs(b, a.o); if (!d) return Bf(new Q("Error: No request builder found for command.", b)); var e = d.o(b, void 0, c); return e ? new wf(function (f) {
            var g, h, k; return w(function (m) {
                if (1 == m.i) {
                    h = "cors" === (null == (g = e.ta) ? void 0 : g.mode) ? "cors" : void 0; if (a.m.md) { var q = e.config, r; q = null == q ? void 0 : null == (r = q.Pa) ? void 0 : r.sessionIndex; r = Ns({ sessionIndex: q }); k = Object.assign({}, Bu(h), r); return m.u(2) } return v(m, Cu(e.config,
                        h), 3)
                } 2 != m.i && (k = m.j); f(Du(a, e, k)); m.i = 0
            })
        }) : Bf(new Q("Error: Failed to build request for command.", b))
    }
    ...
    function Du(a, b, c) {
        var d, e, f, g, h, k, m, q, r, x, u, A, E, F, O, N, R, ca, W, ob, Ya, la, H, ka, ea, Ae, Be, wd; return w(function (na) {
            switch (na.i) {
                case 1: na.u(2); break; case 3: if ((d = na.j) && !d.isExpired()) return na.return(Promise.resolve(d.i())); case 2: if (null == (e = b) ? 0 : null == (f = e.ha) ? 0 : f.context) for (g = p([]), h = g.next(); !h.done; h = g.next())k = h.value, k.Oq(b.ha.context); if (null == (m = a.j) || !m.Uq(b.input, b.ha)) { na.u(4); break } return v(na, a.j.Lq(b.input, b.ha), 5); case 5: return q = na.j, M("kevlar_process_local_innertube_responses_killswitch") ||
    ...
    Su.prototype.handleResponse = function (a) {
    ...
    t(Vu, $n); var jo = new ao("screen-created", Vu), Wu = [], Yu = Xu, Zu = 0; function $u(a, b, c, d, e, f, g) {
        function h() { Ur(new Q("newScreen() parent element does not have a VE - rootVe", b)) }
    ...
    function av(a, b, c, d) {
        var e = d.filter(function (k) { k.csn !== b ? (k.csn = b, k = !0) : k = !1; return k }), f = {
            cttAuthInfo: ns(b),
            ba: b
        }; d = p(d); for (var g = d.next(); !g.done; g = d.next())g = g.value.getAsJson(), (rb(g) || !g.trackingParams && !g.veType) && Ur(Error("Child VE logged with no data")); if (M("il_via_jspb")) {
            var h = new Aj; h.V(b); Cj(h, c.getAsJspb()); hb(e, function (k) { k = k.getAsJspb(); Zd(h, 3, rj, k) });
            "UNDEFINED_CSN" == b ? bv("visualElementAttached", h, f) : zr(h, f, a)
        } else c = { csn: b, parentVe: c.getAsJson(), childVes: hb(e, function (k) { return k.getAsJson() }) }, "UNDEFINED_CSN" == b ? bv("visualElementAttached", c, f) : a ? or("visualElementAttached", c, a, f) : sm("visualElementAttached", c, f)
    }
    ...
    dv.prototype.clickCommand = function (a, b, c) {
        var d = a.clickTrackingParams; c = void 0 === c ? 0 : c; if (d) if (c = ls(void 0 === c ? 0 : c)) {
            a = this.client; var e = fs(d); d = { cttAuthInfo: ns(c), ba: c }; if (M("il_via_jspb")) { var f = new Dj; f.V(c); e = e.getAsJspb(); G(f, rj, 2, e); D(f, 4, mk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK); b && G(f, uj, 3); "UNDEFINED_CSN" == c ? bv("visualElementGestured", f, d) : wr(f, d, a) } else f = { csn: c, ve: e.getAsJson(), gestureType: "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK" }, b && (f.clientData = b), "UNDEFINED_CSN" == c ?
                bv("visualElementGestured", f, d) : a ? or("visualElementGestured", f, a, d) : sm("visualElementGestured", f, d); b = !0
        } else b = !1; else b = !1; return b
    };
    function gv(a, b, c) {
        c = void 0 === c ? {} : c; a.j.add(c.layer || 0); a.l = function () {
            hv(a, b, c); var f = js(c.layer); if (f) {
                for (var g = p(a.o), h = g.next(); !h.done; h = g.next())h = h.value, fv(a, h[0], h[1] || f, c.layer); f = p(a.N); for (g = f.next(); !g.done; g = f.next()) {
                    var k = g.value; g = void 0; g = void 0 === g ? 0 : g; h = ls(g); var m = k[0] || js(g); if (h && m) {
                        g = a.client; var q = k[1]; k = { cttAuthInfo: ns(h), ba: h }; M("il_via_jspb") ? (q = new Gj, q.V(h), m = m.getAsJspb(), G(q, rj, 2, m), "UNDEFINED_CSN" == h ? bv("visualElementStateChanged", q, k) : xr(q, k, g)) : (m = {
                            csn: h, ve: m.getAsJson(),
                            clientData: q
                        }, "UNDEFINED_CSN" == h ? bv("visualElementStateChanged", m, k) : g ? or("visualElementStateChanged", m, g, k) : sm("visualElementStateChanged", m, k))
                    }
                }
            }
        };
    ...
    function Fv(a, b, c, d) {
        d = void 0 === d ? null : d; var e = hf("SCRIPT"); e.id = b; e.onload = function () { c && setTimeout(c, 0) };
    ...
    var Ev = {}; var Iv = [], Jv = !1; function Kv() {
        if (!M("disable_biscotti_fetch_for_ad_blocker_detection") && !M("disable_biscotti_fetch_entirely_for_all_web_clients") && Bs()) {
            var a = L("PLAYER_VARS", {}); if ("1" != tb(a) && !Cs(a)) {
                var b = function () { Jv = !0; "google_ad_status" in window ? Ck("DCLKSTAT", 1) : Ck("DCLKSTAT", 2) };
    ...
    function Qv(a, b, c, d) {
        a.state = 5; try {
            var e = new Ah({ program: b, globalName: c }); e.jd.then(function () { a.state = 6; d && d(b) });
            a.zb(e)
        } catch (f) { a.state = 7, f instanceof Error && Ur(f) }
    }
    ...
    ; function Xv(a) {
        var b = this; var c = void 0 === c ? 0 : c; var d = void 0 === d ? hm() : d; this.m = c; this.l = d; this.j = new zh; this.i = a; a = {}; c = p(this.i.entries()); for (d = c.next(); !d.done; a = { Ba: a.Ba, La: a.La }, d = c.next()) {
            var e = p(d.value); d = e.next().value; e = e.next().value; a.La = d; a.Ba = e; d = function (f) { return function () { f.Ba.sb(); b.i[f.La].bb = !0; b.i.every(function (g) { return !0 === g.bb }) && b.j.resolve() } }(a);
            e = dm(d, Yv(this, a.Ba)); this.i[a.La] = Object.assign({}, a.Ba, { sb: d, Xa: e })
        }
    }
    function Zv(a) {
        var b = Array.from(a.i.keys()).sort(function (d, e) { return Yv(a, a.i[e]) - Yv(a, a.i[d]) });
    ...
    $v.prototype.transition = function (a, b) {
        var c = this, d = this.B.find(function (f) { return f.from === c.state && f.F === a });
        if (d) {
            this.l && (Zv(this.l), this.l = void 0); this.state = a; d = d.action.bind(this); var e = this.plugins.filter(function (f) { return f[a] }).map(function (f) { return f[a] });
    ...
    function aw(a, b, c) {
        return function () {
            ...
            f = f.map(function (k) {
                var m; return {
                    sb: function () { k.callback.apply(k, ia(d)) },
    ...
    ; function kw(a, b, c) {
        J.call(this); var d = this; c = c || L("POST_MESSAGE_ORIGIN") || window.document.location.protocol + "//" + window.document.location.hostname; this.l = b || null; this.targetOrigin = "*"; this.m = c; this.sessionId = null; this.channel = "widget"; this.G = !!a; this.A = function (e) {
            a: if (!("*" != d.m && e.origin != d.m || d.l && e.source != d.l || "string" !== typeof e.data)) {
                try { var f = JSON.parse(e.data) } catch (g) { break a } if (!(null == f || d.G && (d.sessionId && d.sessionId != f.id || d.channel && d.channel != f.channel)) && f) switch (f.event) {
                    case "listening": "null" !=
    ...
    ; function sw(a) {
        lw.call(this); this.listeners = []; this.api = a; this.addEventListener("onReady", this.onReady.bind(this)); this.addEventListener("onVideoProgress", this.fd.bind(this)); this.addEventListener("onVolumeChange", this.gd.bind(this)); this.addEventListener("onApiChange", this.Zc.bind(this)); this.addEventListener("onPlaybackQualityChange", this.cd.bind(this)); this.addEventListener("onPlaybackRateChange", this.dd.bind(this)); this.addEventListener("onStateChange", this.ed.bind(this)); this.addEventListener("onWebglSettingsChanged",
            this.hd.bind(this))
    }
    t(sw, lw); l = sw.prototype;
    l.Eb = function (a, b, c) {
        if (this.api.isExternalMethodAvailable(a, c)) {
            b = b || []; if (0 < b.length && pw(a)) {
                var d = b; if (Qa(d[0]) && !Array.isArray(d[0])) var e = d[0]; else switch (e = {}, a) {
                    case "loadVideoById": case "cueVideoById": e = qw(d[0], void 0 !== d[1] ? Number(d[1]) : void 0, d[2]); break; case "loadVideoByUrl": case "cueVideoByUrl": e = d[0]; "string" === typeof e && (e = { mediaContentUrl: e, startSeconds: void 0 !== d[1] ? Number(d[1]) : void 0, suggestedQuality: d[2] }); b: {
                        if ((d = e.mediaContentUrl) && (d = /\/([ve]|embed)\/([^#?]+)/.exec(d)) && d[2]) {
                            d =
                            d[2]; break b
                        } d = null
                    } e.videoId = d; e = qw(e); break; case "loadPlaylist": case "cuePlaylist": e = rw(d[0], d[1], d[2], d[3])
                }b.length = 1; b[0] = e
            } this.api.handleExternalCall(a, b, c); pw(a) && nw(this, this.nb())
        }
    };
    ...
    function uw(a, b) {
        switch (a) {
            case "loadVideoById": return a = qw(b), [a]; case "cueVideoById": return a = qw(b), [a]; case "loadVideoByPlayerVars": return [b]; case "cueVideoByPlayerVars": return [b]; case "loadPlaylist": return a = rw(b), [a]; case "cuePlaylist": return a = rw(b), [a]; case "seekTo": return [b.seconds, b.allowSeekAhead]; case "playVideoAt": return [b.index]; case "setVolume": return [b.volume]; case "setPlaybackQuality": return [b.suggestedQuality]; case "setPlaybackRate": return [b.suggestedRate]; case "setLoop": return [b.loopPlaylists];
    ...
    function Mw(a) {
        if (!a.i() && !a.P) {
            var b = Qw(a); if (b && "html5" === (Rw(a) ? "html5" : null)) a.R = "html5", a.isReady() || Tw(a); else if (Uw(a), a.R = "html5", b && a.m && a.o) a.o.appendChild(a.m), Tw(a); else {
                a.config && (a.config.loaded = !0); var c = !1; a.G = function () { c = !0; var d = Vw(a, "player_bootstrap_method") ? B("yt.player.Application.createAlternate") || B("yt.player.Application.create") : B("yt.player.Application.create"); var e = a.config ? Ow(a.config) : void 0; d && d(a.o, e, a.webPlayerContextConfig); Tw(a) };
    ...
    function Jw(a) {
        a.da = !1; if (a.W) for (var b in a.j) a.j.hasOwnProperty(b) && a.W(b, a.j[b]); for (var c in a.J) a.J.hasOwnProperty(c) && fl(Number(c)); a.J = {}; a.s = null; a.W = null; b = a.api; for (var d in b) b.hasOwnProperty(d) && (b[d] = null); b.addEventListener = function (e, f) { a.addEventListener(e, f) };
    ...
    function Kw(a) {
        a.addEventListener("WATCH_LATER_VIDEO_ADDED", function (b) { Cq("WATCH_LATER_VIDEO_ADDED", b) });
    ...
    function Pw(a, b) {
        var c = b; if ("string" === typeof b) {
            if (a.la[b]) return a.la[b]; c = function () { var d = Ja.apply(0, arguments), e = B(b); if (e) try { e.apply(y, d) } catch (f) { Tr(f) } };
            a.la[b] = c
        } return c ? c : null
    }
    function $w(a, b) {
        var c = "ytPlayer" + b + a.A; a.j[b] = c; y[c] = function (d) {
            var e = el(function () { if (!a.i()) { try { a.K.qa(b, null != d ? d : void 0) } catch (h) { Ur(new Q("PlayerProxy error when creating global callback", { error: h, event: b, playerId: a.A, data: d })) } var f = a.J, g = String(e); g in f && delete f[g] } }, 0);
            sb(a.J, String(e))
        };
        return c
    }
    ...
    ; var ax = {}, bx = "player_uid_" + (1E9 * Math.random() >>> 0); function cx(a, b, c) {
        var d = "player"; c = void 0 === c ? !0 : c; d = "string" === typeof d ? gf(d) : d; var e = bx + "_" + Ra(d), f = ax[e]; if (f && c) return dx(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api; f = new Iw(d, e, a, b); ax[e] = f; Cq("player-added", f.api); qe(f, function () { delete ax[f.getId()] });
        return f.api
    }
    ...
    ; function lx(a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? !1 : c; var d = L("EVENT_ID"); d && (b.ei || (b.ei = d)); if (b) {
            ...
            var k = void 0 === k ? {} : k; var m = void 0 === m ? "" : m; var q = void 0 === q ? window : q; c = q.location; a = vc(a, k) + m; var r = void 0 === r ? Nh : r; a: { r = void 0 === r ? Nh : r; for (k = 0; k < r.length; ++k)if (m = r[k], m instanceof Lh && m.isValid(a)) { r = new Ob(a, Pb); break a } r = void 0 } r = r || Sb; if (r instanceof Ob) var x = Qb(r); else {
                a: if (Dh) { try { x = new URL(r) } catch (u) { x = "https:"; break a } x = x.protocol } else b: {
                    x = document.createElement("a"); try { x.href = r } catch (u) {
                        x = void 0;
                        break b
                    } x = -1 !== [":", ""].indexOf(x.protocol) ? "https:" : x.protocol
                } x = "javascript:" === x ? "about:invalid" : r
            } c.href = x
        } return !0
    }
    ; z("yt.setConfig", Ck); z("yt.config.set", Ck); z("yt.setMsg", qs); z("yt.msgs.set", qs); z("yt.logging.errors.log", Tr);
    z("writeEmbed", function () {
        var a = L("PLAYER_CONFIG"); if (!a) { var b = L("PLAYER_VARS"); b && (a = { args: b }) } Ls(!0); "gvn" === a.args.ps && (document.body.style.backgroundColor = "transparent"); a.attrs || (a.attrs = { width: "100%", height: "100%", id: "video-player" }); var c = document.referrer; b = L("POST_MESSAGE_ORIGIN"); window !== window.top && c && c !== document.URL && (a.args.loaderUrl = c); M("embeds_js_api_set_1p_cookie") && (c = Xk(window.location.href), c.embedsTokenValue && (a.args.embedsTokenValue = c.embedsTokenValue)); lu(); if ((c = L("WEB_PLAYER_CONTEXT_CONFIGS")) &&
        ...
        M("embeds_web_enable_new_nwl") ? Yo() : fp(); M("ytidb_clear_embedded_player") && Vh.S(function () {
            var e; if (!Uu) {
                var f = ft(), g = { wb: Tu, nc: Su }; f.providers.set(g.wb, g); g = { Mb: { feedbackEndpoint: gt(Ou), modifyChannelNotificationPreferenceEndpoint: gt(Pu), playlistEditEndpoint: gt(Qu), subscribeEndpoint: gt(Mu), unsubscribeEndpoint: gt(Nu), webPlayerShareEntityServiceEndpoint: gt(Ru) } }; var h = M("web_enable_client_location_service") ? Us.getInstance() : void 0, k = {}; h && (k.client_location = h); if (void 0 === m) {
                    Ms.i || (Ms.i = new Ms); var m =
                        Ms.i
                } void 0 === e && (e = f.resolve(Tu)); zu(g, e, m, k); m = { wb: Fu, oc: yu.i }; f.providers.set(m.wb, m); Uu = f.resolve(Fu)
            } uv()
        })
    });
    var mx = Kk(function () {
        su(); var a = zl.getInstance(), b = Cl(119), c = 1 < window.devicePixelRatio; if (document.body && gi(document.body, "exp-invert-logo")) if (c && !gi(document.body, "inverted-hdpi")) { var d = document.body; if (d.classList) d.classList.add("inverted-hdpi"); else if (!gi(d, "inverted-hdpi")) { var e = ei(d); fi(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi")) } } else !c && gi(document.body, "inverted-hdpi") && hi(); if (b != c) {
            b = "f" + (Math.floor(119 / 31) + 1); d = Dl(b) || 0; d = c ? d | 67108864 : d & -67108865; 0 == d ? delete yl[b] : (c = d.toString(16),
                yl[b] = c.toString()); c = !0; M("web_secure_pref_cookie_killswitch") && (c = !1); b = a.i; d = []; for (var f in yl) d.push(f + "=" + encodeURIComponent(String(yl[f]))); vl(b, d.join("&"), 63072E3, a.j, c)
        } dv.i || (dv.i = new dv); a = dv.i; f = 16623; var g = void 0 === g ? {} : g; Object.values(rs).includes(f) || (Ur(new Q("createClientScreen() called with a non-page VE", f)), f = 83769); g.isHistoryNavigation || a.i.push({ rootVe: f, key: g.key || "" }); a.o = []; a.N = []; g.Pb ? gv(a, f, g) : hv(a, f, g)
    }), nx = Kk(function () {
    ...
    z("yt.util.activity.init", B("yt.util.activity.init") || rq); z("yt.util.activity.getTimeSinceActive", B("yt.util.activity.getTimeSinceActive") || uq); z("yt.util.activity.setTimestamp", B("yt.util.activity.setTimestamp") || sq);
}).call(this);
